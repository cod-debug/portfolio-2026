    ...
    return (
        <Container>
            ...
            <div className="text-center p-4 gap-4 flex flex-col">
                <FadeInRight>
                    <h1 className="text-4xl font-bold mt-12 text-secondary-accent">
                        PROJECTS
                    </h1>
                </FadeInRight>
                <FadeInLeft>
            ...
            <div className="hidden lg:block">
                <FadeInUp>
                    <div className="border border-gray-700 bg-gradient-to-tr from-primary-background to-secondary-background rounded-lg">
