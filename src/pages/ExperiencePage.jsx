...
const timelineData = [
    {
        ...
        description:
            "Responsible for developing and maintaining websites/web applications. Technologies used: <strong>HTML, CSS, JavaScript, CodeIgniter, Laravel, VueJs, ReactJs, Flutter (Dart), Docker, Vagrant Box</strong>",
    },
    {
        ...
        description:
            "Responsible for leading a front-end team, developing and maintaining websites/web applications, and collaborating with Project Managers and System Analysts. Technologies used: <strong>Laravel, CodeIgniter, Nodejs (Express), Vuejs (NuxtJs and Quasar), ReactJs, React Native, Docker.</strong>",
    },
    {
        ...
        description:
            "Responsible for creating the school’s website and digital logbook with RFID for both students and employees. Technologies used: <strong>PHP, HTML, CSS, JavaScript, JQuery, and Filezilla for FTP.</strong>",
    },
    {
        ...
        description:
            "Created their own website. <strong>Technology used: HTML, CSS, JavaScript, PHP</strong>",
    },
    {
        position: "Web Developer",
        ...
        duration: "June 2020 - August 2020 (part-time)",
        description:
            "Created an election voting app for doctors. Technology used: <strong>HTML, CSS, JavaScript, Django (Python)</strong>",
    },
    {
        ...
        description:
            "Responsible for creating reports using <strong>crystal report</strong> and <strong>SQL</strong>, manage <strong>WIX website</strong>. Technologies used: <strong>EBT accounting app, SQL, WIX corvid, Crystal report</strong>.",
    },
];
